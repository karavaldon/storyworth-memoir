        ...
        <div className={`relative flex flex-1 items-center gap-4 ${!showBar && !showTimeline2 ? 'justify-center' : 'justify-between'}`}>
          ...
          {showTimeline2 && (
            <div className="relative flex-shrink-0" style={{ animation: 'milestone-in 0.4s ease-out both' }}>
              <button type="button"
                className="flex gap-[8px] items-center h-[40px] px-[12px] rounded-[20px] border-2 border-transparent hover:border-[#61706f] hover:bg-white transition-colors cursor-pointer group/milestone"
